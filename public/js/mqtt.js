...
Paho.MQTT = (function (u) {
    ...
    function G(a, b, c) {
        for (var h = "", e, d = b; d < b + c; ) {
            ...
            if (!(128 > e)) {
                ...
                if (0 > p)
                    throw Error(
                        f(g.MALFORMED_UTF, [e.toString(16), p.toString(16), ""])
                    );
    ...
    n.prototype.encode = function () {
        ...
        void 0 != this.messageIdentifier &&
            (f = y(this.messageIdentifier, l, f));
        switch (this.type) {
            case 1:
                ...
                void 0 != this.password &&
                    r(this.password, m(this.password), l, f);
                break;
            case 3:
                l.set(g, f);
                break;
    ...
    k.prototype.store = function (a, b) {
        ...
        switch (b.type) {
            case 3:
                ...
                c.payloadMessage.destinationName =
                    b.payloadMessage.destinationName;
    ...
    var I = function (a, b, c, h) {
        ...
        this._setOnMessageDelivered = function (a) {
            if ("function" === typeof a) l.onMessageDelivered = a;
                ...
                throw Error(
                    f(g.INVALID_TYPE, [typeof a, "onMessageDelivered"])
                );
        };
        ...
        this.connect = function (a) {
            ...
            if (a.hosts) {
                if (!(a.hosts instanceof Array))
                    throw Error(
                        f(g.INVALID_ARGUMENT, [a.hosts, "connectOptions.hosts"])
                    );
                if (1 > a.hosts.length)
                    throw Error(
                        f(g.INVALID_ARGUMENT, [a.hosts, "connectOptions.hosts"])
        ...
        this.subscribe = function (a, b) {
            ...
            if (
                ...
                throw Error(
                    f(g.INVALID_ARGUMENT, [b.qos, "subscribeOptions.qos"])
                );
            l.subscribe(a, b);
        };
